...
Usage:
    grafana-backup save [--config=<filename>] [--flat] [--components=<folders,dashboards,datasources,alert-channels,organizations,users>] [--no-archive]
...
Options:
    ...
    --flat                                                          Not add timestamp to folder name
