...
def main(args, settings):
    ...
    try:
        ...
        print(
            "Permission denied: {0}, please grant `Storage Admin` to service account you used".format(
                str(e)
            )
        )
        return False
        ...
        print(
            "The file: {0} or gcs bucket: {1} doesn't exist".format(
                arg_archive_file, bucket_name
            )
        )
        return False
